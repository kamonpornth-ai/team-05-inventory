...
- `src/notifiers.py` = Notifier protocol/base + EmailNotifier, SMSNotifier + NotifierFactory
...
## หลักการออกแบบ
- ยึด SOLID โดยเฉพาะ SRP, OCP, LSP, ISP, DIP
- เพิ่มช่องทางแจ้งเตือนใหม่ได้โดยไม่แก้ `InventoryService` (OCP)
- ใช้ Observer Pattern สำหรับการแจ้งเตือนหลายช่องทาง
- ใช้ Factory Pattern สำหรับสร้าง Notifier
